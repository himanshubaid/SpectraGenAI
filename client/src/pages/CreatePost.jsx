      ...
      <form className="mt-16 max-w-3xl" onsubmit={handleSubmit}>
          <div className="flex-flex-col gap-5">
            ...
            <FormField
             ...
             />
            {/*for ai generated image containers we made*/}
            <div class="relative bg-gray-50 border
            border-gray-300 text-gray-900 text-sm rounded-lg
            focus:ring-blue-500 focus:border-blue-500 w-64 p-3h-64
          ...
          <div class="mt-10">
              <p>Once you have created the image you want ,
                you can share it with others in this commumity</p>
